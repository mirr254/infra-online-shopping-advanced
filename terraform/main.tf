...
resource "aws_route_table_associatiation" "public-route-1-association" {
  route_table_id = "${aws_route_table.public_route_table.id}"
  subnet_id      = "${aws_subnet.public_subnet_1.id}"
}

resource "aws_route_table_associatiation" "public-route-2-association" {
  route_table_id = "${aws_route_table.public_route_table.id}"
  subnet_id      = "${aws_subnet.public_subnet_2.id}"
}

resource "aws_route_table_associatiation" "public-route-3-association" {
  route_table_id = "${aws_route_table.public_route_table.id}"
